...
function Wednesday({ navigation }) {
  ...
  const Save = async () => {
    await AsyncStorage.setItem("A2", A.toString());
    await AsyncStorage.setItem("B2", B.toString());
    await AsyncStorage.setItem("C2", C.toString());
    await AsyncStorage.setItem("D2", D.toString());
    await AsyncStorage.setItem("E2", E.toString());
    await AsyncStorage.setItem("F2", F.toString());
  ...
  const load = async () => {
    const A = await AsyncStorage.getItem("A2");
    const B = await AsyncStorage.getItem("B2");
    const C = await AsyncStorage.getItem("C2");
    const D = await AsyncStorage.getItem("D2");
    const E = await AsyncStorage.getItem("E2");
    const F = await AsyncStorage.getItem("F2");
      ...
      <View style={[styles.main]}>
        <View style={[styles.Headerbox]}>
          ...
          <View style={[styles.textbox]}>
            <Text style={styles.dayheader}>Wednesday</Text>
          </View>
          <View style={[styles.arrowbox]}>
            <Ionicons
